<template>
  <div id="app" :class="{ 'text-dark': !nightMode, 'text-light': nightMode }">
    <LiYaNavbar @childEvent="childEvent" @scroll="scrollTo" @nightMode="switchMode" :nightMode="nightMode" />
    <div class="parent">
...
<!--      <Contact id="contact" :nightMode="nightMode" />-->
      <router-view/>
      <LiYaFooter :nightMode="nightMode" />
    </div>
  </div>
</template>
...
import LiYaNavbar from "@/components/LiYa/LiYaNavbar";
import LiYaFooter from "./components/LiYa/LiYaFooter";
...
export default {
  ...
  mounted() {
    // ["about", "contact", "skills", "portfolio"]
        ["contact"].forEach((l) => {
