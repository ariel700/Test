      ...
      <vue-tabs :activeTextColor="!nightMode ? '#535A5E' : '#dfdfdf'">
        ...
        <v-tab title="List">
          ...
          <tr>
            ...
            <tr v-for="item in company_info">
              <!--div var a = {{item.cont.length}}-->
              <td rowspan= 1>
                {{item.name}}</td>
              <td>
                <div v-for="items in item.cont">{{items}} <br></div>
              </td>
            </tr>
          </table>
        </v-tab>
...
export default {
  ...
  data() {
    return {
      ...
      company_info: info.companyData,
      //company_cont: info.companyData.cont.length,
      portfolio_info: [],
      showModal: false,
...
.vue-tabs .customers > td, th{
  border: 1px solid #ddd;
  padding: 8px;
}
.vue-tabs .customers > tr:nth-child(even){background-color: antiquewhite/*#f2f2f2*/;}
.vue-tabs .customers > tr:hover {background-color: cornsilk/*#ddd*/;}
.vue-tabs .customers > tr th {
  padding-top: 12px;
  padding-bottom: 12px;
  text-align: left;
  background-color: #8585ad; /*#04AA6D;*/
  color: white;
}

.vue-tabs .customers > tr th:first-child {
  border-top-left-radius: 10px;
}
.vue-tabs .customers > tr th:last-child {
  border-top-right-radius: 10px;
}

.vue-tabs .customers > tr:last-child td:first-child{
  border-bottom-left-radius: 10px;
}

.vue-tabs .customers > tr:last-child td:last-child {
  border-bottom-right-radius: 10px;
}
